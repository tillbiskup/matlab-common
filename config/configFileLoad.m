function [ data, warnings ] = configFileLoad ( fileName, varargin )
% CONFIGFILELOAD Load a Windows-style ini file and return them as
% MATLAB(r) struct structure. 
%
% Usage
%   data = configFileLoad(filename)
%   [data,warnings] = configFileLoad(filename)
%   data = configFileLoad(filename,'<parameter>','<option>')
%
%   filename - string
