function [ warnings ] = configFileSave ( fileName, data, varargin )
% CONFIGFILESAVE Save a MATLAB(r) structure to a Windows-style ini file.
%
% Usage
%   configFileSave(filename,data)
%   status = configFileSave(filename,data)
%   configFileSave(filename,data,'<parameter>','<option>')
%
%   filename - string
...
%                         Default: =
%
% See also: configFileLoad 

% (c) 2008-14, Till Biskup, Bernd Paulus
% 2014-04-04
